                        ...
                        @forelse ($technologies as $technology)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.technologies.edit', $technology) }}" class="btn btn-success mx-2">Edit</a>
                                    <button technology="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="{{ '#modal' . $technology->id}}">Delete</button>
